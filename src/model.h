...
private:
    ...
    QuantWeight load_tensor_raw(const std::string& name,
        ...
        // F32 and all natively-supported quantized/float types: use the raw
        // GGUF pointer directly.  gguf.owned_data (or the mmap region) owns
        // this memory and lives as long as the Model object does.
